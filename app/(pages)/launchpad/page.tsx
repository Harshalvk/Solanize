...
const page = (props: Props) => {
  ...
  return (
    <div className="min-w-96 h-screen flex flex-col items-center justify-center">
      <div>
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-semibold tracking-tighter text-center bg-gradient-to-t from-zinc-400 to-white bg-clip-text text-transparent mb-6">
